#include "../../tc/tc/clocksmallwindow.h"
...
lon::clock_window::ClockSmallWindow::ClockSmallWindow(const QString& label_name,
    ...
    // 设置工具提示，告诉用户可以双击放大
    this->setToolTip(QString(u8"滚轮：调整透明度\n双击：放大回主窗口"));
    ...
    connect(tools_widget_,
            &lon::ToolsWidget::stopButtonClicked,
            this,
            &lon::clock_window::ClockSmallWindow::clockStoped);
    connect(tools_widget_,
            &lon::ToolsWidget::closeButtonClicked,
            this,
            &lon::clock_window::ClockSmallWindow::smallWindowClosing);
}
...
void lon::clock_window::ClockSmallWindow::mouseDoubleClickEvent(QMouseEvent* event) {
    // 双击时发出信号，请求显示主窗口
