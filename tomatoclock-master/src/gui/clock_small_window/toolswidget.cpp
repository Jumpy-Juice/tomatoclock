...
lon::ToolsWidget::ToolsWidget(const QString& label_name,
    ...
    connect(stop_, &Button::clicked, this, &lon::ToolsWidget::stopButtonClicked);
    connect(close_, &Button::clicked, this, &lon::ToolsWidget::closeButtonClicked);
}
