...
public:
    ...
    void setupUi(QWidget *SettingWidgetPrivate)
    {
        if (SettingWidgetPrivate->objectName().isEmpty())
            SettingWidgetPrivate->setObjectName("SettingWidgetPrivate");
        ...
        main_layout_p_->setObjectName("main_layout_p_");
        gridlayout_top_p_ = new QGridLayout();
        gridlayout_top_p_->setSpacing(6);
        gridlayout_top_p_->setObjectName("gridlayout_top_p_");
        time_remind_label_p_ = new QLabel(SettingWidgetPrivate);
        time_remind_label_p_->setObjectName("time_remind_label_p_");
        ...
        spacer_left_p_ = new QSpacerItem(40, 20, QSizePolicy::Policy::Minimum, QSizePolicy::Policy::Minimum);
        ...
        time_setting_layout_p_->setObjectName("time_setting_layout_p_");
        work_remind_label_p = new QLabel(SettingWidgetPrivate);
        work_remind_label_p->setObjectName("work_remind_label_p");
        ...
        spacer_1_1_p_ = new QSpacerItem(40, 20, QSizePolicy::Policy::Fixed, QSizePolicy::Policy::Minimum);

        horizontalLayout_1->addItem(spacer_1_1_p_);

        verticallayout_p_ = new QVBoxLayout();
        verticallayout_p_->setSpacing(6);
        verticallayout_p_->setObjectName("verticallayout_p_");
        work_slider_p_ = new QSlider(SettingWidgetPrivate);
        work_slider_p_->setObjectName("work_slider_p_");
        ...
        work_slider_p_->setCursor(QCursor(Qt::CursorShape::PointingHandCursor));
        ...
        work_label_p_->setObjectName("work_label_p_");
        ...
        spacer_1_2_p_ = new QSpacerItem(40, 20, QSizePolicy::Policy::Expanding, QSizePolicy::Policy::Minimum);
        ...
        shortbreak_remind_label_p->setObjectName("shortbreak_remind_label_p");
        ...
        spacer_2_1_p_ = new QSpacerItem(40, 20, QSizePolicy::Policy::Minimum, QSizePolicy::Policy::Minimum);

        horizontalLayout_2->addItem(spacer_2_1_p_);

        verticallayout_2_p_ = new QVBoxLayout();
        verticallayout_2_p_->setSpacing(6);
        verticallayout_2_p_->setObjectName("verticallayout_2_p_");
        shortbreak_slider_p_ = new QSlider(SettingWidgetPrivate);
        shortbreak_slider_p_->setObjectName("shortbreak_slider_p_");
        ...
        short_break_p_->setObjectName("short_break_p_");
        ...
        spacer_2_2_p_ = new QSpacerItem(40, 20, QSizePolicy::Policy::Expanding, QSizePolicy::Policy::Minimum);
        ...
        longbreak_remind_label_p->setObjectName("longbreak_remind_label_p");
        ...
        spacer_3_1_p_ = new QSpacerItem(40, 20, QSizePolicy::Policy::Minimum, QSizePolicy::Policy::Minimum);

        horizontalLayout->addItem(spacer_3_1_p_);

        verticallayout_3_p_ = new QVBoxLayout();
        verticallayout_3_p_->setSpacing(6);
        verticallayout_3_p_->setObjectName("verticallayout_3_p_");
        long_break_slider_p_ = new QSlider(SettingWidgetPrivate);
        long_break_slider_p_->setObjectName("long_break_slider_p_");
        ...
        long_break_label_p_->setObjectName("long_break_label_p_");
        ...
        spacer_3_2_p_ = new QSpacerItem(40, 20, QSizePolicy::Policy::Expanding, QSizePolicy::Policy::Minimum);
        ...
        break_time_label_p->setObjectName("break_time_label_p");
        ...
        spacer_4_1_p_ = new QSpacerItem(40, 20, QSizePolicy::Policy::Minimum, QSizePolicy::Policy::Minimum);

        horizontalLayout_3->addItem(spacer_4_1_p_);

        verticallayout_3_p_1 = new QVBoxLayout();
        verticallayout_3_p_1->setSpacing(6);
        verticallayout_3_p_1->setObjectName("verticallayout_3_p_1");
        break_time_slider_p_ = new QSlider(SettingWidgetPrivate);
        break_time_slider_p_->setObjectName("break_time_slider_p_");
        ...
        break_time_label_p_->setObjectName("break_time_label_p_");
        ...
        spacer_4_2_p_ = new QSpacerItem(40, 20, QSizePolicy::Policy::Expanding, QSizePolicy::Policy::Minimum);
        ...
        other_setting_label_p_->setObjectName("other_setting_label_p_");
        ...
        line_bottom_p_->setObjectName("line_bottom_p_");
        line_bottom_p_->setFrameShape(QFrame::Shape::HLine);
        line_bottom_p_->setFrameShadow(QFrame::Shadow::Sunken);

        gridLayout_3->addWidget(line_bottom_p_, 1, 0, 1, 2);

        spacer_bottom_left_p_ = new QSpacerItem(20, 20, QSizePolicy::Policy::Minimum, QSizePolicy::Policy::Minimum);
        ...
        spacer_bottom_right_p_ = new QSpacerItem(40, 20, QSizePolicy::Policy::Minimum, QSizePolicy::Policy::Minimum);
        ...
        check_box_p_->setObjectName("check_box_p_");
    ...
    {
        SettingWidgetPrivate->setWindowTitle(QCoreApplication::translate("SettingWidgetPrivate", "Translate", nullptr));
        time_remind_label_p_->setText(QCoreApplication::translate("SettingWidgetPrivate", "\346\227\266\351\225\277\350\256\276\347\275\256", nullptr));
        work_remind_label_p->setText(QCoreApplication::translate("SettingWidgetPrivate", "\345\267\245\344\275\234\346\227\266\351\225\277", nullptr));
        work_label_p_->setText(QCoreApplication::translate("SettingWidgetPrivate", "25 : 00", nullptr));
        shortbreak_remind_label_p->setText(QCoreApplication::translate("SettingWidgetPrivate", "\347\237\255\344\274\221\346\201\257\346\227\266\351\225\277", nullptr));
        short_break_p_->setText(QCoreApplication::translate("SettingWidgetPrivate", "5 : 00", nullptr));
        longbreak_remind_label_p->setText(QCoreApplication::translate("SettingWidgetPrivate", "\351\225\277\344\274\221\346\201\257\346\227\266\351\225\277", nullptr));
        long_break_label_p_->setText(QCoreApplication::translate("SettingWidgetPrivate", "15 : 00", nullptr));
        break_time_label_p->setText(QCoreApplication::translate("SettingWidgetPrivate", "\346\257\217\351\232\224\345\244\232\345\260\221\344\270\252\346\256\265\344\274\221\346\201\257\350\277\233\350\241\214\344\270\200\346\254\241\351\225\277\344\274\221\346\201\257", nullptr));
        break_time_label_p_->setText(QCoreApplication::translate("SettingWidgetPrivate", "3", nullptr));
        other_setting_label_p_->setText(QCoreApplication::translate("SettingWidgetPrivate", "\345\205\266\344\273\226\350\256\276\347\275\256", nullptr));
        plainTextEdit->setPlainText(QCoreApplication::translate("SettingWidgetPrivate", "\n"
"                                                    \350\256\276\347\275\256\350\277\236\347\273\255\345\267\245\344\275\234\346\204\217\345\221\263\347\235\200\346\257\217\344\270\252\347\225\252\350\214\204\351\222\237\347\273\223\346\235\237\344\274\232\350\207\252\345\212\250\345\274\200\345\247\213\344\270\213\344\270\200\344\270\252\347\225\252\350\214\204\351\222\237\343\200\202\345\274\200\345\220\257\346\255\244\351\241\271\345\220\216\357\274\214\345\246\202\346\236\234\345\234\250\346\237\220\344\270\252\347\225\252\350\214\204\351\222\237\347\273\223\346\235\237\345\220\216\346\203\263\345\201\234\346\255\242\345\267\245\344\275\234\357\274\214\345\217\252\350\203\275\346\217\220\345\211\215\347\273\223\346\235\237\350\207\252\345\212\250\345\274\200\345\247\213\347\232\204\347\225\252\350\214\204\357\274\214\344\270\215\350\277\207\357\274\214\345\260\221\344\272\2163\345\210\206\351\222\237\347\232\204\347\225\252\350\214\204\346\230\257\344\270\215\344\274\232\350\256\260\345\275\225\347\232"
                        "\204\343\200\202\n"
"                                                ", nullptr));
        check_box_p_->setText(QCoreApplication::translate("SettingWidgetPrivate", "\346\230\257\345\220\246\350\277\236\347\273\255\345\267\245\344\275\234", nullptr));
    } // retranslateUi
